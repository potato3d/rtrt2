...
/* Definitions                                                          */
/************************************************************************/
USING_VR_INTEGER_TYPES

typedef uint32 RTenum;

// Error codes
#define RT_OK                       0x0000
#define RT_NO_MEMORY                0x0001
#define RT_INVALID_PARAM			0x0003

// Reference axis
#define RT_AXIS_X					0x0000
#define RT_AXIS_Y					0x0001
#define RT_AXIS_Z					0x0002

// Primitive types
#define RT_TRIANGLES				0x1001
#define RT_TRIANGLE_STRIP			0x1002
//#define RT_TRIANGLE_FAN				0x1003
//#define RT_QUADS						0x1004
//#define RT_QUAD_STRIP					0x1005
