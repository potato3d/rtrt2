...
/* String                                                               */
/************************************************************************/
// TODO: make these for vr::String inside vrbase
...
inline static int32 stringCompareNoCase( const std::string& ref, const std::string& other )
{
	std::string lowerRef( ref );
	std::string lowerOther( other );
	stringToLowercase( lowerRef );
	stringToLowercase( lowerOther );
	return lowerRef.compare( lowerOther );
}
